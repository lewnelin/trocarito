$(document).ready(function () {
    ...
    $('#TabelaListar').DataTable({
        "processing": true,
        ajax: "?m=cadastro&c=logoEmpreendimento&a=listar",
        "columns": [
            {"data": 'checkbox'},
            {"data": 'codigo'},
            {"data": "empreendimento"},
        ...
        initComplete: function () {
            ...
            var btnAdicionar = '<a class="btn btn-success btn-sm" href="?m=cadastro&c=logoEmpreendimento&a=adicionar"><i class="fa fa-plus-circle"></i> Adicionar</a>';
