$(document).ready(function () {
    ...
    $('#TabelaListar').DataTable({
        "processing": true,
        ajax: "?m=cadastro&c=agendamentoCrm&a=listar",
        "columns": [
        ...
        initComplete: function () {
            ...
            var btnAdicionar = '<a class="btn btn-success btn-sm" href="?m=cadastro&c=agendamentoCrm&a=adicionar"><i class="fa fa-plus-circle"></i> Adicionar</a>';
