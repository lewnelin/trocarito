<fieldset>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="form-group col-sm-6">
                ...
                <input type="text" class="form-control maskCpf" id="nrCpf" name="nrCpf" data-mask="999.999.999-99" placeholder="Digite o CPF da pessoa." required>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="form-group col-sm-6">
                <label for="nrFax" class="control-label">Nº Tel. Recado: </label>
                <input type="text" class="form-control maskTelefone" name="nrFax" placeholder="Digite o número de telefone para recado da pessoa">
            </div>
        </div>
    </div>
    <div class="row">
...
<fieldset id="infoConjuge">
    <legend>Informações do Cônjuge</legend>
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group col-sm-6">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="form-group col-sm-6">
                <label for="sexoConjuge" class="control-label">Sexo do Cônjuge:</label><br />
                <?php
                foreach($this->get('listaSexo') as $sexo) {
                    $idSexo = 'sexoConjuge'.$sexo['idCampo'];
                    $checked = ($sexo['idCampo'])?'checked':'';
                    ?>
                    <label for="<?= $idSexo?>" class="control-label" style="padding-top: 8px;">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group col-sm-6">
                ...
                <label for="utilizarEnderecoConjugeS" class="control-label" style="padding-top: 8px;">
                    Sim <input type="radio" id="utilizarEnderecoConjugeS" name="utilizarEnderecoConjuge" value="1" checked/>
                </label>
                <label for="utilizarEnderecoConjugeN" class="control-label" style="padding-top: 8px;">
...
<fieldset id="enderecoConjuge">
    <legend>Endereço do Cônjuge</legend>
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group col-sm-6">
    ...
    <div class="row" id="divDocumento">
        <div class="col-sm-12 divDocs">
            ...
            <div class="form-group col-sm-5">
                <label for="nmMae" class="control-label">Arquivo do Documento:</label>
                <input type="file" class="form-control btn btn-primary" name="arquivoDocumento[]" title='Escolher arquivo'/>
            </div>
            <div class="form-group col-sm-1">
                <label for="btnAddCampoArquivo" class="control-label">Excluir</label>
                <button id="btnAddCampoArquivo" tabindex="-1" style="height: 35px" class="form-control btn btn-red-1 btn-sm btnExcluirDocumento" type="button">
...
<fieldset>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group col-sm-6">
                <button type="submit" class="form-control btn btn-primary" id="btnSalvar">Salvar</button>
            </div>
            <div class="form-group col-sm-6">
