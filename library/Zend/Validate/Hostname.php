...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
     ...
     * (.DK) Danmark http://www.dk-hostmaster.dk/index_manutencao.php?id=151
     ...
     * (.ORG) International http://www.pir.org/index_manutencao.php?db=content/FAQs&tbl=FAQs_Registrant&id=2
     ...
     * (.TR) Turkey https://www.nic.tr/index_manutencao.php
