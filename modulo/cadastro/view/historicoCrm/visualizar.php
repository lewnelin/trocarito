            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group col-sm-6">
                        <label
                            class="control-label"><b><?php echo ($primeiroContato['id_tipo_contato'] == '131') ? 'Indicado Por:' : 'Cliente:' ?></b></label> <?= ($infoIndicacao['nmPessoaCliente']) ? $infoIndicacao['nmPessoaCliente'] : $infoIndicacao['nmPessoaUsuario'] ?>
                    </div>
                    <div class="form-group col-sm-6">
