...
<form action="?m=cadastro&c=parametroComissao&a=deletar" method="POST">
...
<div class="table-responsive">
    <table id="TabelaListar"
        ...
        <thead>
        <tr>
            <th style="width: 1px;"><div align="center"><input type="checkbox" class="rows-check" id="checkPrincipal"></div></th>
            <th>Cod.</th>
            <th>Empreendimento</th>
            <th>Nome Parâmetro</th>
