    ...
    <form id='registerForm' class="form" role="form" method="POST" action="?m=<?php echo $_GET['m'] ?>&c=<?php echo $_GET['c']; ?>&a=<?php echo $_GET['a']; ?>">
        <fieldset>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group col-sm-6">
                        <label for="nmIndicado" class="control-label">Pessoa Indicada: <span class="text-danger"
                                                                                             title="Este campo é obrigatório.">*</span></label>
                        <input type="text" class="form-control" id="nmIndicado" name="nmIndicado" value=""
                               placeholder="Digite o nome do Cliente" required>
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="nrTelefone" class="control-label">Telefone: <span class="text-danger"
                                                                                      title="Este campo é obrigatório.">*</span></label>
                        <input type="text" class="form-control maskTelefone" id="nrTelefone" name="nrTelefone" value=""
                               placeholder="Digite o telefone do Cliente" required>
                    </div>
                    <div class="form-group col-sm-4">
                        <label for="dsEmail" class="control-label">E-Mail:</label>
                        <input type="text" class="form-control" id="dsEmail" name="dsEmail" value=""
                ...
                <div class="col-sm-12">
                    <div class="form-group col-sm-3">
                        <label for="dtContato" class="control-label">Data: <span class="text-danger"
                                                                                 title="Este campo é obrigatório.">*</span></label>
                        <input type="text" class="form-control limpaCampos maskData dtpicker" id="dtContato"
                               name="dtContato" value="<?= date('d/m/Y') ?>" placeholder="Digite a Data" required>
                    </div>
                    <div class="form-group col-sm-3">
                        <label for="hrContato" class="control-label">Hora: <span class="text-danger"
                                                                                 title="Este campo é obrigatório.">*</span></label>
                        <input type="text" class="form-control maskHora limpaCampos" id="hrContato" name="hrContato"
                               value="<?= date('H:i:s') ?>" placeholder="Digite a Hora" required>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="dsContato" class="control-label">Observação: </label>
                        <textarea id="dsContato" name="dsContato" class="form-control" cols="6" rows="3"></textarea>
                    </div>
                </div>
            </div>
