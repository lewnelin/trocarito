...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="form-group col-sm-6">
            <label for="estrangeiro" class="control-label"></label><br />
            <?php
            foreach($this->get('radioEstrangeiro') as $estrangeiro) {
                $idRadio = 'estrangeiro'.$estrangeiro['idCampo'];
                $checked = (($estrangeiro['idCampo'] == 'B')?'checked':'');
                ?>
                <label for="<?= $idRadio ?>" class="control-label" style="padding-top: 8px; cursor:pointer;">
                    <?= $estrangeiro['descricao'] ?> <input type="radio" id="<?= $idRadio ?>" name="estrangeiro" value="<?= $estrangeiro['idCampo'] ?>" <?= $checked ?>/>
                </label>
            <?php
            }
            ?>
...
<div class="row">
    <div class="col-sm-12">
        <div class="form-group col-sm-6">
            <label for="tpDocumento" class="control-label">Tipo de Documento: <span class="text-danger" title="Este campo é obrigatório.">*</span></label>
            <br><select class="form-control" name="tpDocumento" required="required" style="width:382px;">
                <?php Helper::geraOptionsSelect($this->get("listaDocumentos"), 'idCampo', 'descricao'); ?>
            </select>
        </div>
        <div class="form-group col-sm-6">
            <label for="nrRg" class="control-label">Numero do Documento: <span class="text-danger" title="Este campo é obrigatório.">*</span></label>
            <input type="text" class="form-control" id="nrRg" name="nrRg" placeholder="Digite o documento da pessoa." required="required">
        </div>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="form-group col-sm-6">
            <label for="nrCpf" class="control-label">CPF: <span class="text-danger" id="dangerCPF" title="Este campo é obrigatório.">*</span></label>
            <input type="text" class="form-control maskCpf" id="nrCpf" name="nrCpf" placeholder="Digite o CPF da pessoa.">
        </div>
        <div class="form-group col-sm-6">
...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="form-group col-sm-6">
            <label for="cdCidadeNascimento" class="control-label">Cidade de Nascimento: <span id="dangerCdCidadeNascimento" class="text-danger" title="Este campo é obrigatório.">*</span></label>
            <br><select class="form-control " name="cdCidadeNascimento" required="required" style="width:382px;">
...
<div class="row infoConjuge">
    <div class="col-sm-12">
        <div class="form-group col-sm-6" id="divNmConjuge">
            <label for="nrCpfConjuge" class="control-label">CPF do Cônjuge: <span class="text-danger" id="dangerCpfConjuge" title="Este campo é obrigatório.">*</span></label>
        ...
        <div class="form-group col-sm-6">
            <label for="estrangeiroConjuge" class="control-label"></label><br />
            <?php
            foreach($this->get('radioEstrangeiroConjuge') as $estrangeiroConjuge) {
                $idRadio = 'estrangeiroConjuge'.$estrangeiroConjuge['idCampo'];
                $checked = (($estrangeiroConjuge['idCampo'] == 'B')?'checked':'');
                ?>
                <label for="<?= $idRadio ?>" class="control-label" style="padding-top: 8px; cursor:pointer;">
                    <?= $estrangeiroConjuge['descricao'] ?> <input type="radio" id="<?= $idRadio ?>" name="estrangeiroConjuge" value="<?= $estrangeiroConjuge['idCampo'] ?>" <?= $checked ?>/>
                </label>
            <?php
            }
            ?>
...
<div class="row infoConjuge">
    <div class="col-sm-12">
        ...
        <div class="form-group col-sm-6">
            ...
            <input type="text" class="form-control maskData" name="dtNascimentoConjuge" placeholder="Digite a data de nascimento do cônjuge.">
        </div>
    </div>
</div>
<div class="row infoConjuge">
    <div class="col-sm-12">
        <div class="form-group col-sm-6">
            <label for="tpDocumentoConjuge" class="control-label">Tipo de Documento: <span class="text-danger" title="Este campo é obrigatório.">*</span></label>
            <br><select class="form-control" name="tpDocumentoConjuge" required="required" style="width:382px;">
                <?php Helper::geraOptionsSelect($this->get("listaDocumentos"), 'idCampo', 'descricao'); ?>
            </select>
        </div>
        <div class="form-group col-sm-6">
            <label for="nrRgConjuge" class="control-label">Numero do Documento: <span class="text-danger" title="Este campo é obrigatório.">*</span></label>
            <input type="text" class="form-control" id="nrRgConjuge" name="nrRgConjuge" placeholder="Digite o documento do cônjuge." required="required">
        </div>
    </div>
</div>
<div class="row infoConjuge">
...
<div class="row enderecoConjuge">
    <div class="col-sm-12">
        ...
        <div class="form-group col-sm-6">
            ...
            <br><select class="form-control " name="cdCidadeConjuge" style="width:382px;">
                <?php Helper::geraOptionsSelect($this->get("listaCidades"), 'id', array('[nome]/[uf]',array('nome','uf'))); ?>
            </select>
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="form-group col-sm-6">
            ...
            <input type="text" class="form-control maskData" name="dtNascimento" placeholder="Digite data de nascimento da pessoa" size="100">
        </div>
        <div class="form-group col-sm-6">
...
<div class="row">
    <div class="col-sm-12">
        <div class="form-group col-sm-6">
            ...
            <br><select class="form-control" name="cdCidade" required="required" style="width:382px;">
                <?php Helper::geraOptionsSelect($this->get("listaCidades"), 'id', array('[nome]/[uf]',array('nome','uf'))); ?>
            </select>
        </div>
        <div class="form-group col-sm-6">
